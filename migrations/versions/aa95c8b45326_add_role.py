...
Revision ID: aa95c8b45326
Revises: 
Create Date: 2026-01-14 15:19:14.831300
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('client', 'artisan'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    sa.PrimaryKeyConstraint('review_id', 'service_id')
    )
